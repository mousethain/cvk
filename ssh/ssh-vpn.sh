...
curl -sS https://raw.githubusercontent.com/mousethain/cvk/mouse/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/mousethain/cvk/mouse/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/mousethain/cvk/mouse/ssh/newudpgw"
...
#wget https://raw.githubusercontent.com/mousethain/cvk/mouse/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/mousethain/cvk/mouse/menu/menu.sh"
...
wget -O m-ssws "https://raw.githubusercontent.com/mousethain/cvk/mouse/menu/m-ssws.sh"
wget -O m-trojan "https://raw.githubusercontent.com/mousethain/cvk/mouse/menu/m-trojan.sh"
